...
### env replaced
/usr/bin/sed -i "s/\"Dev\"/\"Prod\"/g" $2
/usr/bin/sed -i "s/\"dev\"/\"Prod\"/g" $2
#/usr/bin/sed -i "s/dev/uat/g" $2
/usr/bin/sed -i "s/-dev-/-prod-/g" $2
/usr/bin/sed -i "s/_dev_/_prod_/g" $2
...
/usr/bin/sed -i "s/${ecv_dev_id}/${ecr_prod_id}/g" $2
...
/usr/bin/sed -i "s/${ecv_dev_subnets_1}/${ecr_prod_subnets_1}/g" $2
/usr/bin/sed -i "s/${ecv_dev_subnets_2}/${ecr_prod_subnets_2}/g" $2
/usr/bin/sed -i "s/${ecv_dev_sg}/${ecr_prod_sg}/g" $2
...
/usr/bin/sed -i "s/${dev_userdata}/${c8prod_userdata}/g" $2
