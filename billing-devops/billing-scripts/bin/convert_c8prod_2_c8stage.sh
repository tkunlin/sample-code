...
### Create by Richrad.Tsai 2023-12-12
### 
...
### env replaced
/usr/bin/sed -i "s/\"Prod\"/\"Stage\"/g" $2
# /usr/bin/sed -i "s/\"prod\"/\"stage\"/g" $2
# /usr/bin/sed -i "s/dev/uat/g" $2
/usr/bin/sed -i "s/-prod-/-stage-/g" $2
/usr/bin/sed -i "s/_prod_/_stage_/g" $2
...
/usr/bin/sed -i "s/${ecr_prod_id}/${ecr_uat_id}/g" $2
...
/usr/bin/sed -i "s/${ecr_prod_subnets_1}/${ecr_stage_subnets_1}/g" $2
/usr/bin/sed -i "s/${ecr_prod_subnets_2}/${ecr_stage_subnets_2}/g" $2
/usr/bin/sed -i "s/${ecr_prod_sg}/${ecr_stage_sg}/g" $2
...
ecr_prod_role=":806235885150:role"
ecr_stage_role=":168051394147:role"
/usr/bin/sed -i "s/${ecr_prod_role}/${ecr_stage_role}/g" $2
...
prod_userdata="IyEvYmluL2Jhc2gKZWNobyAiRUNTX0NMVVNURVI9YmlsbGluZy1wcm9kLWpvYiAiPj4gL2V0Yy9lY3MvZWNzLmNvbmZpZw=="
...
c8prod_userdata="IyEvYmluL2Jhc2gKZWNobyAiRUNTX0NMVVNURVI9YmlsbGluZy1wcm9kLWpvYiAiPj4gL2V0Yy9lY3MvZWNzLmNvbmZpZw=="
/usr/bin/sed -i "s/${c8prod_userdata}/${c8stage_userdata}/g" $2
