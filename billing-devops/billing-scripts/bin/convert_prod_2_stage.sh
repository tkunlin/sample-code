...
### AWS ID replaced
/usr/bin/sed -i "s/":960216436767:"/":863203846708:"/g" $2
...
ecv_stage_subnets_2="subnet-01da4771bd3195aa6"
ecv_stage_sg="sg-06bf17ebdda9cb944"
#
ecv_prod_subnets_1="subnet-0598352c1b611c3f5"
ecv_prod_subnets_2="subnet-075277cb3e9bae077"
ecv_prod_sg="sg-0e88b8715a9ac5b84"
#
#
/usr/bin/sed -i "s/${ecv_prod_subnets_1}/${ecv_stage_subnets_1}/g" $2
/usr/bin/sed -i "s/${ecv_prod_subnets_2}/${ecv_stage_subnets_2}/g" $2
/usr/bin/sed -i "s/${ecv_prod_sg}/${ecv_stage_sg}/g" $2
#
#### UserData replaced
...
/usr/bin/sed -i "s/${prod_userdata}/${stage_userdata}/g" $2