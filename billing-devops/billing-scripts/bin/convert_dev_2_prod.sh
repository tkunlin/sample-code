...
/usr/bin/sed -i "s/${ecv_dev_subnets_1}/${ecv_prod_subnets_1}/g" $2
/usr/bin/sed -i "s/${ecv_dev_subnets_2}/${ecv_prod_subnets_2}/g" $2
/usr/bin/sed -i "s/${ecv_dev_sg}/${ecv_prod_sg}/g" $2
...
/usr/bin/sed -i "s/${dev_userdata}/${prod_userdata}/g" $2
